...
import facade.DespesaFixaFacade;
 ...
 * @author belarmino
 */
public class DespesaFixaVisao extends javax.swing.JDialog {

    private DespesaFixa despesa;
    private DespesaFixaFacade facade;

    /**
     * Creates new form DespesaVisao
     */
    public DespesaFixaVisao(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        enableComponents(false);
        facade = new DespesaFixaFacade();
    }
    ...
    private void enableComponents(boolean status) {
        ...
        jtDespesaFixa.setEnabled(!status);
    ...
    private void updateTable() {
        despesaFixaList.clear();
        despesaFixaList.addAll(facade.findAll());
    }
    ...
    private void initComponents() {
        ...
        despesaEntityManager = java.beans.Beans.isDesignTime() ? null : javax.persistence.Persistence.createEntityManagerFactory("db_tcc_miqueiasPU").createEntityManager();
        despesaQuery = java.beans.Beans.isDesignTime() ? null : despesaEntityManager.createQuery("SELECT d FROM DespesaFixa d");
        despesaFixaList = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : org.jdesktop.observablecollections.ObservableCollections.observableList(despesaQuery.getResultList());
        ...
        setTitle("SGLMC - Despesa Fixa");

        jpDados.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        jLabel1.setText("Descrição:");

        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, jtDespesaFixa, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.descricao}"), jtfDescricao, org.jdesktop.beansbinding.BeanProperty.create("text"));
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, jtDespesaFixa, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.valor}"), jtfValor, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, jtDespesaFixa, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.dataVencimento}"), jtfDiaVencimento, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);
            ...
            .addGroup(jpDadosLayout.createSequentialGroup()
                ...
                .addGroup(jpDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jpDadosLayout.createSequentialGroup()
                        ...
                        .addComponent(jtfDiaVencimento, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE))
                ...
                .addGroup(jpDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jpDadosLayout.createSequentialGroup()
                        ...
                        .addGroup(jpDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(jLabel4)
                            .addComponent(jtfDiaVencimento, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        jpFiltro.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        jcbOpcoes.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Descrição", "Valor", "Status", "Vencimento" }));
        ...
        jtDespesaFixa.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        jtDespesaFixa.getTableHeader().setReorderingAllowed(false);

        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, despesaFixaList, jtDespesaFixa);
        ...
        columnBinding.setColumnName("Dia de Vencimento");
        ...
        jTableBinding.bind();
        jScrollPane1.setViewportView(jtDespesaFixa);
        if (jtDespesaFixa.getColumnModel().getColumnCount() > 0) {
            jtDespesaFixa.getColumnModel().getColumn(0).setResizable(false);
            jtDespesaFixa.getColumnModel().getColumn(1).setResizable(false);
            jtDespesaFixa.getColumnModel().getColumn(2).setResizable(false);
            jtDespesaFixa.getColumnModel().getColumn(3).setResizable(false);
            jtDespesaFixa.getColumnModel().getColumn(4).setResizable(false);
        }
        ...
        jpFiltroLayout.setHorizontalGroup(
            ...
            .addGroup(jpFiltroLayout.createSequentialGroup()
                ...
                .addGroup(jpFiltroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jpFiltroLayout.createSequentialGroup()
                        .addComponent(jcbOpcoes, javax.swing.GroupLayout.PREFERRED_SIZE, 172, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jtfPesquisa, javax.swing.GroupLayout.PREFERRED_SIZE, 312, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jbtCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtCadastrarActionPerformed
        ...
        despesa = new DespesaFixa();
        despesaFixaList.add(despesa);
        int linha = despesaFixaList.size() - 1;
        jtDespesaFixa.setRowSelectionInterval(linha, linha);
        jtfDescricao.requestFocus();
    }//GEN-LAST:event_jbtCadastrarActionPerformed

    private void jbtGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtGravarActionPerformed
        if (despesa == null) {
            despesa = despesaFixaList.get(jtDespesaFixa.getSelectedRow());
            facade.updateData(despesa);
    ...
    private void jbtAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtAtualizarActionPerformed
        if (jtDespesaFixa.isRowSelected(jtDespesaFixa.getSelectedRow())) {
            enableComponents(true);
            despesa = null;
        } else {
    ...
    private void jbtDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtDeletarActionPerformed
        if (jtDespesaFixa.isRowSelected(jtDespesaFixa.getSelectedRow())) {
            facade.deleteData(despesaFixaList.get(jtDespesaFixa.getSelectedRow()));
            updateTable();
            enableComponents(false);
        } else {
            JOptionPane.showMessageDialog(null, "Selecione um registro!");
    ...
    private void jbtFiltrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtFiltrarActionPerformed
        ...
        if (search.isEmpty()) {
            ...
            switch (op) {
                case "Descrição": {
                    despesaFixaList.addAll(facade.findByDescription(search));
                    break;
                }
                case "Valor": {
                    try {
                        double val = Double.parseDouble(search);
                        despesaFixaList.addAll(facade.findByValue(val));
                    } catch (Exception e) {
                ...
                case "Status": {
                    despesaFixaList.addAll(facade.findByStatus(search));
                    break;
                }
                case "Vencimento": {
                    try {
                        int day = Integer.parseInt(search);
                        despesaFixaList.addAll(facade.findByDayPayment(day));
                    } catch (Exception e) {
                    }
                    break;
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DespesaFixaVisao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DespesaFixaVisao dialog = new DespesaFixaVisao(new javax.swing.JFrame(), true);
    ...
    private javax.persistence.EntityManager despesaEntityManager;
    private java.util.List<entidade.DespesaFixa> despesaFixaList;
    ...
    private javax.swing.JTable jtDespesaFixa;
    private javax.swing.JTextField jtfDescricao;
    private javax.swing.JTextField jtfDiaVencimento;
